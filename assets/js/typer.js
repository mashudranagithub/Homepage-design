var Typer = function(element) {
  ...
  this.delay = element.dataset.delay || 10;
  this.loop = element.dataset.loop || "false";
  this.deleteDelay = element.dataset.deletedelay || element.dataset.deleteDelay || 100;
...
Typer.prototype.doTyping = function() {
  ...
  if (this.cursor) {
    ...
    this.cursor.interval = setInterval(function() {itself.updateBlinkState();}, 1000);
  }
